...
def main():
    ...
    """
    read_file_path = str(input("Enter the need-to-be-augmentated file path: "))
    ...
    write_file_path = str(input("Enter the path for saving the augmentated file: "))
    write_audio(write_file_path, augmented_audio, sample_rate)

    print(f'Done! Your augmentated audio file has been placed in this directory: {write_file_path}')
